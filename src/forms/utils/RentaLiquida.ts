import { calculateTotalsSources, calculateTotals } from "./totalOperations";
  ...
  for (const key in obj) {
    ...
    if (typeof value === "number") {
      if (!parents.includes(obj)) {
        ...
        calculateValorFiscalSolicitado(obj);
...
export const calculatedValorFiscal = (data: any) => {
  ...
  data.ValorFiscal =
    ...
    (data?.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano || 0) -
    (data?.MenorValorFiscalPorReconocimientoExencionesLimitaciones || 0) +
    (data?.MayorValorFiscalPorReconocimientoExencionesLimitaciones || 0);
};
...
export const calculateTotalIngresosNetosAvIn = (data: any) => {
  if (
    data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.Total == null
  ) {
    return;
  }

  data.Ingresos.IngresosNetosActividadIndustrialComercialYServicios.Total.ValorContable =
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.IngresosNetosActividadIndustrialComercialYServicios?.Total
      ?.ValorContable || 0) -
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.DevolucionesRebajasYDescuentos?.Total?.ValorContable || 0);

  data.Ingresos.IngresosNetosActividadIndustrialComercialYServicios.Total.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano =
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.IngresosNetosActividadIndustrialComercialYServicios?.Total
      ?.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano || 0) -
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.DevolucionesRebajasYDescuentos?.Total
      ?.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano || 0);

  data.Ingresos.IngresosNetosActividadIndustrialComercialYServicios.Total.MenorValorFiscalPorReconocimientoExencionesLimitaciones =
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.IngresosNetosActividadIndustrialComercialYServicios?.Total
  ...
  data.Ingresos.IngresosNetosActividadIndustrialComercialYServicios.Total.ValorFiscal =
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.IngresosNetosActividadIndustrialComercialYServicios?.Total
      ?.ValorFiscal || 0) -
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.DevolucionesRebajasYDescuentos?.Total?.ValorFiscal || 0);

  data.Ingresos.IngresosNetosActividadIndustrialComercialYServicios.Total.TarifaDel9Porciento =
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.IngresosNetosActividadIndustrialComercialYServicios?.Total
      ?.TarifaDel9Porciento || 0) -
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.DevolucionesRebajasYDescuentos?.Total?.TarifaDel9Porciento || 0);

  data.Ingresos.IngresosNetosActividadIndustrialComercialYServicios.Total.TarifaDel15Porciento =
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.IngresosNetosActividadIndustrialComercialYServicios?.Total
      ?.TarifaDel15Porciento || 0) -
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.DevolucionesRebajasYDescuentos?.Total?.TarifaDel15Porciento || 0);

  data.Ingresos.IngresosNetosActividadIndustrialComercialYServicios.Total.TarifaDel20Porciento =
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.IngresosNetosActividadIndustrialComercialYServicios?.Total
      ?.TarifaDel20Porciento || 0) -
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.DevolucionesRebajasYDescuentos?.Total?.TarifaDel20Porciento || 0);

  data.Ingresos.IngresosNetosActividadIndustrialComercialYServicios.Total.MegaInversiones =
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.IngresosNetosActividadIndustrialComercialYServicios?.Total
      ?.MegaInversiones || 0) -
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.DevolucionesRebajasYDescuentos?.Total?.MegaInversiones || 0);
  ...
  data.Ingresos.IngresosNetosActividadIndustrialComercialYServicios.Total.MegaInversiones27Porciento =
    ...
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.DevolucionesRebajasYDescuentos?.Total?.MegaInversiones27Porciento || 0);

  data.Ingresos.IngresosNetosActividadIndustrialComercialYServicios.Total.TarifaGeneralArticulo240ET =
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.IngresosNetosActividadIndustrialComercialYServicios?.Total
      ?.TarifaGeneralArticulo240ET || 0) -
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.DevolucionesRebajasYDescuentos?.Total?.TarifaGeneralArticulo240ET || 0);

  data.Ingresos.IngresosNetosActividadIndustrialComercialYServicios.Total.Otras =
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.IngresosNetosActividadIndustrialComercialYServicios?.Total?.Otras ||
      0) -
    (data?.Ingresos?.IngresosNetosActividadIndustrialComercialYServicios
      ?.DevolucionesRebajasYDescuentos?.Total?.Otras || 0);
};
...
export const calculateTotalIngresos = (data: any) => {
  calculateTotalsSources(
    ...
    [
      ...
      data?.Ingresos
        ?.IngresosPorReversionDeProvisionesPasivosDeMontoOFechaInciertos?.Total,
      data?.Ingresos?.IngresosPorReversionDePasivosPorBeneficiosALosEmpleados
        ?.Total,
  ...
  data.Ingresos.TotalIngresos.MayorValorFiscalPorReconocimientoExencionesLimitaciones =
    (data?.Ingresos?.TotalIngresos
      ?.MayorValorFiscalPorReconocimientoExencionesLimitaciones || 0) -
    (data?.Ingresos?.MenosIngresosNoConstitutivosDeRentaNiGananciaOcasional
      ?.MayorValorFiscalPorReconocimientoExencionesLimitaciones || 0);

  data.Ingresos.TotalIngresos.ValorFiscal =
    (data?.Ingresos?.TotalIngresos?.ValorFiscal || 0) -
    (data?.Ingresos?.MenosIngresosNoConstitutivosDeRentaNiGananciaOcasional
      ?.ValorFiscal || 0);

  data.Ingresos.TotalIngresos.TarifaDel9Porciento =
    (data?.Ingresos?.TotalIngresos?.TarifaDel9Porciento || 0) -
    (data?.Ingresos?.MenosIngresosNoConstitutivosDeRentaNiGananciaOcasional
      ?.TarifaDel9Porciento || 0);

  data.Ingresos.TotalIngresos.TarifaDel15Porciento =
    (data?.Ingresos?.TotalIngresos?.TarifaDel15Porciento || 0) -
    (data?.Ingresos?.MenosIngresosNoConstitutivosDeRentaNiGananciaOcasional
      ?.TarifaDel15Porciento || 0);

  data.Ingresos.TotalIngresos.TarifaDel20Porciento =
    (data?.Ingresos?.TotalIngresos?.TarifaDel20Porciento || 0) -
    (data?.Ingresos?.MenosIngresosNoConstitutivosDeRentaNiGananciaOcasional
      ?.TarifaDel20Porciento || 0);

  data.Ingresos.TotalIngresos.MegaInversiones =
    (data?.Ingresos?.TotalIngresos?.MegaInversiones || 0) -
    (data?.Ingresos?.MenosIngresosNoConstitutivosDeRentaNiGananciaOcasional
      ?.MegaInversiones || 0);

  data.Ingresos.TotalIngresos.MegaInversiones27Porciento =
    (data?.Ingresos?.TotalIngresos?.MegaInversiones27Porciento || 0) -
    (data?.Ingresos?.MenosIngresosNoConstitutivosDeRentaNiGananciaOcasional
      ?.MegaInversiones27Porciento || 0);

  data.Ingresos.TotalIngresos.TarifaGeneralArticulo240ET =
    (data?.Ingresos?.TotalIngresos?.TarifaGeneralArticulo240ET || 0) -
    (data?.Ingresos?.MenosIngresosNoConstitutivosDeRentaNiGananciaOcasional
      ?.TarifaGeneralArticulo240ET || 0);

  data.Ingresos.TotalIngresos.Otras =
    (data?.Ingresos?.TotalIngresos?.Otras || 0) -
    (data?.Ingresos?.MenosIngresosNoConstitutivosDeRentaNiGananciaOcasional
      ?.Otras || 0);
};
...
export const calculateGananciaOPerdida = (data: any) => {
  ...
  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.ValorContable =
    (data?.Ingresos?.TotalIngresos?.ValorContable || 0) -
    (data?.Costos?.TotalCostos?.ValorContable || 0) -
    (data?.Gastos?.TotalGastos?.ValorContable || 0);

  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano =
    (data?.Ingresos?.TotalIngresos
      ?.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano || 0) -
    (data?.Costos?.TotalCostos
      ?.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano || 0) -
    (data?.Gastos?.TotalGastos
      ?.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano || 0);

  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.MenorValorFiscalPorReconocimientoExencionesLimitaciones =
    (data?.Ingresos?.TotalIngresos
      ?.MenorValorFiscalPorReconocimientoExencionesLimitaciones || 0) -
    (data?.Costos?.TotalCostos
      ?.MenorValorFiscalPorReconocimientoExencionesLimitaciones || 0) -
  ...
  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.MayorValorFiscalPorReconocimientoExencionesLimitaciones =
    (data?.Ingresos?.TotalIngresos
      ?.MayorValorFiscalPorReconocimientoExencionesLimitaciones || 0) -
    (data?.Costos?.TotalCostos
      ?.MayorValorFiscalPorReconocimientoExencionesLimitaciones || 0) -
  ...
  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.ValorFiscal =
    (data?.Ingresos?.TotalIngresos?.ValorFiscal || 0) -
    (data?.Costos?.TotalCostos?.ValorFiscal || 0) -
    (data?.Gastos?.TotalGastos?.ValorFiscal || 0);

  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.TarifaDel9Porciento =
    (data?.Ingresos?.TotalIngresos?.TarifaDel9Porciento || 0) -
    (data?.Costos?.TotalCostos?.TarifaDel9Porciento || 0) -
    (data?.Gastos?.TotalGastos?.TarifaDel9Porciento || 0);

  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.TarifaDel15Porciento =
    (data?.Ingresos?.TotalIngresos?.TarifaDel15Porciento || 0) -
    (data?.Costos?.TotalCostos?.TarifaDel15Porciento || 0) -
    (data?.Gastos?.TotalGastos?.TarifaDel15Porciento || 0);

  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.TarifaDel20Porciento =
    (data?.Ingresos?.TotalIngresos?.TarifaDel20Porciento || 0) -
    (data?.Costos?.TotalCostos?.TarifaDel20Porciento || 0) -
    (data?.Gastos?.TotalGastos?.TarifaDel20Porciento || 0);

  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.MegaInversiones =
    (data?.Ingresos?.TotalIngresos?.MegaInversiones || 0) -
    (data?.Costos?.TotalCostos?.MegaInversiones || 0) -
    (data?.Gastos?.TotalGastos?.MegaInversiones || 0);

  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.MegaInversiones27Porciento =
    (data?.Ingresos?.TotalIngresos?.MegaInversiones27Porciento || 0) -
    (data?.Costos?.TotalCostos?.MegaInversiones27Porciento || 0) -
    (data?.Gastos?.TotalGastos?.MegaInversiones27Porciento || 0);

  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.TarifaGeneralArticulo240ET =
    (data?.Ingresos?.TotalIngresos?.TarifaGeneralArticulo240ET || 0) -
    (data?.Costos?.TotalCostos?.TarifaGeneralArticulo240ET || 0) -
    (data?.Gastos?.TotalGastos?.TarifaGeneralArticulo240ET || 0);

  data.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida.Otras =
    (data?.Ingresos?.TotalIngresos?.Otras || 0) -
    (data?.Costos?.TotalCostos?.Otras || 0) -
    (data?.Gastos?.TotalGastos?.Otras || 0);
};

export const calculateLiquidasPasivasECE = (data: any) => {
  data.RentaLiquidaOrdinariaDelEjercicioIncluyendeoDividendosYAntesDeLasRentasLiquidasPasivasECE =
    (data?.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida?.ValorFiscal ||
      0) > 0
      ? data?.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida
          ?.ValorFiscal || 0
      : 0;

  data.OPerdidaLiquidaOrdinariaDelEjercicioIncluyendoDividendosYAntesDeLaRentasLiquidasPasivasECE =
    (data?.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida?.ValorFiscal ||
      0) +
      (data?.Ingresos?.RentasLiquidasPasivasECE?.ValorFiscal || 0) <
    0
      ? (data?.GanaciaOPerdidaAntesDeImpuestoALaRentaORentaLiquida
          ?.ValorFiscal || 0) +
        (data?.Ingresos?.RentasLiquidasPasivasECE?.ValorFiscal || 0)
  ...
  data.RentasLiquidasPasivasECE.ValorContable =
    (data?.RentasPasivasECE?.Ingresos?.Total?.ValorContable || 0) -
    (data?.RentasPasivasECE?.Costos?.ValorContable || 0) -
    (data?.RentasPasivasECE?.Deduccionesl?.ValorContable || 0);

  data.RentasLiquidasPasivasECE.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano =
    (data?.RentasPasivasECE?.Ingresos?.Total
      ?.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano || 0) -
    (data?.RentasPasivasECE?.Costos
      ?.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano || 0) -
    (data?.RentasPasivasECE?.Deduccionesl
      ?.EfectoConversionMonedaFuncionalDiferenteAlPesoColombiano || 0);
  ...
  data.RentasLiquidasPasivasECE.ValorFiscal =
    (data?.RentasPasivasECE?.Ingresos?.Total?.ValorFiscal || 0) -
    (data?.RentasPasivasECE?.Costos?.ValorFiscal || 0) -
    (data?.RentasPasivasECE?.Deduccionesl?.ValorFiscal || 0);
};

export const calculateRentaLiquidaUnicamenteDividendos = (data: any) => {
  data.RentaLquidaIncluyeDividendosDeSociedadesNacionalesATarifaGeneral.ValorFiscal =
    (data
      ?.RentaLiquidaOrdinariaDelEjercicioExcedenteNetoIncluyeUnicamenteDividendosDeSociedadesNacionalesATarifaGeneral
      ?.ValorFiscal || 0) - (data?.Compensaciones?.Total?.ValorFiscal || 0);
};

export const calculateRentaPresuntiva = (data: any) => {
  data.RentaPresuntiva.BaseDeCalculoDeLaRentaPresuntiva.ValorFiscal =
    (data?.RentaPresuntiva?.PatrimonioLiquidoDelAnioOPeriodoGravableAnterior
      ?.ValorFiscal || 0) +
    (data?.RentaPresuntiva?.ValorPatrimonialNeto
      ?.AccionesYAportesPoseidosEnSociedadesNacionales?.ValorFiscal || 0) +
    (data?.RentaPresuntiva?.ValorPatrimonialNeto
      ?.BienesAfectadosPorHechosConstitutosDeFuerzaMayorOCasoFortuito
      ?.ValorFiscal || 0) +
    (data?.RentaPresuntiva?.ValorPatrimonialNeto
      ?.BienesVinculadosAEmpresasEnPeriodoImproductivo?.ValorFiscal || 0) +
    (data?.RentaPresuntiva?.ValorPatrimonialNeto
      ?.BienesDestinadosExclusivamenteAActividadesDeportivas?.ValorFiscal ||
      0) +
    (data?.RentaPresuntiva?.ValorPatrimonialNeto
      ?.BienesVinculadosAEmpresasExclusivamenteMineras?.ValorFiscal || 0) +
    (data?.RentaPresuntiva
      ?.Primeras19000UVTDeActivosDestinadosAlSectorAgropecuario?.ValorFiscal ||
      0) +
    (data?.RentaPresuntiva?.OtrasExclusiones?.ValorFiscal || 0);

  data.RentaPresuntiva.CalculoRentaPresuntiva0PorcientoSalvoExcepciones.ValorFiscal = 0;

  data.RentaPresuntiva.Total.ValorFiscal =
    data?.RentaPresuntiva?.BaseDeCalculoDeLaRentaPresuntiva?.ValorFiscal || 0;
};

export const calculateRentasLiquidasGravables = (data: any) => {
  const valueFiscal =
    (data?.RentaLquidaIncluyeDividendosDeSociedadesNacionalesATarifaGeneral
      ?.ValorFiscal || 0) -
    (data?.RentaExenta?.ValorFiscal || 0) +
    (data?.RentasGravablesRentaLiquida?.Total?.ValorFiscal || 0);

  data.RentasLiquidasGravables.ValorFiscal =
    (data?.RentaPresuntiva?.Total?.ValorFiscal || 0) >
    (data?.RentaExenta?.ValorFiscal || 0)
      ? valueFiscal
      : 0;
};
...
export const calculateGananciasOcasionalesGravables = (data: any) => {
  data.GananciasOcasionalesGravables.TotalIngresosPorGananciasOcasionales.ValorFiscal =
    (data?.GananciasOcasionalesGravables
      ?.IngresosPorGananciaOcasionalEnVentaDeActivosFijos?.ValorFiscal || 0) +
    (data?.GananciasOcasionalesGravables?.OtrosIngresosPorGananciaOcasional
      ?.ValorFiscal || 0);

  data.GananciasOcasionalesGravables.TotalCostosPorGananciasOcasionales.ValorFiscal =
    (data?.GananciasOcasionalesGravables
      ?.CostosPorGananciaOcasionalEnVentaDeActivosFijos?.ValorFiscal || 0) +
    (data?.GananciasOcasionalesGravables?.OtrosCostosPorGananciasOcasionales
      ?.ValorFiscal || 0);
};

export const calculateTotalRetencionesAnioGravableQueDeclara = (data: any) => {
  data.TotalRetencionesAnioGravableQueDeclara.ValorFiscal =
    (data?.Autorretenciones?.TotalAutorretenciones?.ValorFiscal || 0) -
    (data?.OtrasRetenciones?.TotalOtrasRetenciones?.ValorFiscal || 0);
};

export const calculateInformativoOtroResultadoIntegralORII = (data: any) => {
  const valuesGanancia =
    (data?.InformativoOtroResultadoIntegralORII?.NoSeReclasificanAlResultado
      ?.Total?.Ganancia || 0) +
    (data?.InformativoOtroResultadoIntegralORII?.SeReclasificanAlResultado
      ?.Total?.Ganancia || 0);
  ...
  data.InformativoOtroResultadoIntegralORII.OTROResultadoIntegralAntesDeImpuestos.Ganancia =
    valuesGanancia - valuesPerdida > 0 ? valuesGanancia - valuesPerdida : 0;

  data.InformativoOtroResultadoIntegralORII.OTROResultadoIntegralAntesDeImpuestos.EfectoConversion =
    valuesPerdida - valuesGanancia > 0 ? valuesPerdida - valuesGanancia : 0;

  const auxValue =
    (data
      ?.CreditoFiscalParaInversionesEnProyectosDeInvestigacionDesarrolloTecnologicoEInnovacionOVinculacionDeCapitalHumanoDeAltoNivelArt2561DelETCreadoConArt168Ley1955MayoDe2019
      ?.ValorFiscal || 0) +
    ((data?.InformativoOtroResultadoIntegralORII
      ?.OTROResultadoIntegralAntesDeImpuestos?.ValorFiscal || 0) -
      (data?.InformativoOtroResultadoIntegralORII
        ?.OTROResultadoIntegralAntesDeImpuestos?.EfectoConversion || 0));

  data.InformativoOtroResultadoIntegralORII.ResultadoIntegralTotalDelAnio.Ganancia =
    auxValue > 0 ? auxValue : 0;

  data.InformativoOtroResultadoIntegralORII.ResultadoIntegralTotalDelAnio.Perdida =
    auxValue < 0 ? auxValue * -1 : 0;
};

export const calculateAllPartOne = (newData: any) => {
  ...
  calculateTotalsSources(
    newData?.Gastos?.GastosDeDistribucionYVentas,
    [
      newData?.Gastos?.GastosDeDistribucionYVentas?.ManoDeObra?.Total,
      newData?.Gastos?.GastosDeDistribucionYVentas
        ?.OtrosGastosDeDistribucionYVentas?.Total,
      newData?.Gastos?.GastosDeDistribucionYVentas
        ?.DepreciacionesAmortizacionesYDeterioros?.Total,
    ],
    "Total"
  );
...
export const calculateAllPartTwo = (newData: any) => {
  calculateTotalsSources(
    newData?.InformativoClasificacionDiferencias
      ?.AjustesAlResultadoContablePorDiferenciasTemporalesQueAfectenAlResultado,
    [
      newData?.InformativoClasificacionDiferencias
        ?.AjustesAlResultadoContablePorDiferenciasTemporalesQueAfectenAlResultado
        ?.DiferenciasTemporalesDeducibles?.TotalDiferenciasTemporalesDeducibles,
      newData?.InformativoClasificacionDiferencias
        ?.AjustesAlResultadoContablePorDiferenciasTemporalesQueAfectenAlResultado
        ?.DiferenciasTemporalesImponibles?.TotalDiferenciasTemporalesImponibles,
      newData?.InformativoClasificacionDiferencias
        ?.AjustesAlResultadoContablePorDiferenciasTemporalesQueAfectenAlResultado
        ?.OtrasDiferenciasTemporales?.TotalOtrasDiferenciasTemporales,
    ],
    "Total"
  );
